    ...
    return (
        <div className="h-screen bg-gradient-to-r from-[#87A8FA] to-[#87CCFA] overflow-hidden">
            ...
            <div className="grid grid-cols-2 justify-items-center items-center mx-20 h-[90%]">
                <DashboardCard url="/properties" imageUrl={PropertiesImg} name="Properties" onClick={() => handleCardClick('Properties')}/>
                <DashboardCard url="/finance" imageUrl={FinanceImg} name="Finance" onClick={() => handleCardClick('Finance')}/>
