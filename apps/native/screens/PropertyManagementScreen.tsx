...
import {PropertyAdapter} from "../components/PropertyAdapter";
import {processCondoUnits} from '../components/processCondoUnits';
...
const CondoProfileScreen = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const userUID : any = await AsyncStorage.getItem("userUID");
                ...
                propertiesCollectionSnapshot.forEach(async (propertyDoc) => {
                    ...
                    if (propertyData.owner === userUID) {
                        ...
                        // This is a placeholder, replace it with your actual code to fetch the user's role
                        const userRole = await fetchUserRole(userUID);
