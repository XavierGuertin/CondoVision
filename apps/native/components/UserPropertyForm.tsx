...
/**
 * A form component for submitting user properties.
 * @param {Object} props - Component props.
 * @param {Function} props.onFormSubmit - Callback function to execute upon form submission.
 * @param {string} props.propertyID - The ID of the property.
 */
const UserPropertyForm = ({ onFormSubmit, propertyID }) => {
    ...
    /**
   * Handles the submission of the form, including validation and database operations.
   */
